...
export default function ProblemsPage() {
  return (
    <div className="flex flex-col w-full items-center pt-24 px-4 bwgradient">
      <div className="w-full max-w-md flex flex-col"> {/* Removed h-full */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-white mb-4">Problems Page</h1>
          <p className="text-white">Browse through the different categories of problems, each with a detailed description.</p>
        </div>
        <TabGroup className="flex-grow flex flex-col overflow-hidden">
          ...
          <TabPanels className="mt-3 flex-grow overflow-y-auto scrollbar-hide">
